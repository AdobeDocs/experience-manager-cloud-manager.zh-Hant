...
如需有關使用基本驗證對網站和資產進行效能測試的更多詳細資訊，請參閱[已驗證的效能測試](#authenticated-performance-testing)。
...
>[!TIP]
>
>請參閱[設定生產管道](/help/using/production-pipelines.md)，了解更多資訊。如需了解如何設定方案以及定義您的 KPI，請參閱[程式設定](/help/getting-started/program-setup.md)。
