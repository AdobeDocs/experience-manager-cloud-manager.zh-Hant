...
+ 使用 {#using}
   + CI/CD 管道 {#pipelines}
      ...
      + [分割階段和僅生產管道](/help/using/stage-prod-only.md)
   ...
   + {hide-from-toc}[開發環境的Service Pack更新（私人測試版）](/help/using/service-packs-environments.md)
...
+ 管理程式碼 {#managing-code}
   ...
   + [新增外部存放庫](/help/managing-code/external-repositories.md)
   + [管理存取權杖](/help/managing-code/manage-access-tokens.md)
