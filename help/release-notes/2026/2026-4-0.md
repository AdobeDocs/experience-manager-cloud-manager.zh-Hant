...
* **支援AEM Experience Hub中的使用者介面擴充性。**
  ...
  [AEM Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub)中的使用者介面擴充功能支援功能現已啟用。 如此一來，開發人員就能使用Adobe App Builder建立的自訂功能和Widget來擴充介面。
