...
[Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub)是AEM的中央存取點，根據您組織的需求進行自訂。 為Adobe提供您現有AEM UI擴充功能的詳細資訊，協助您在Experience Hub中啟用這些功能。
