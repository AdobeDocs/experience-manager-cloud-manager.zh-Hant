...
使用webhooks-1![提取請求的](/help/managing-code/assets/azure-devops-validation-of-pull-requests-with-webhooks-1.png)Azure DevOps驗證

程式碼品質驗證完成後，狀態檢查會更新以反映結果：

使用webhooks-2![提取請求的](/help/managing-code/assets/azure-devops-validation-of-pull-requests-with-webhooks-2.png)Azure DevOps驗證
