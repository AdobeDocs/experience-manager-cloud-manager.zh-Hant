...
| 2 | ![資訊圖示](/help/getting-started/assets/Info.svg)快速入門 | 按一下以存取[上線檔案歷程](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-cloud-service/content/onboarding/journey/overview)，讓您快速上手並執行Cloud Manager。<br>上線歷程是針對Adobe Experience Manager as a Cloud Service (AEMaaCS)上的Cloud Manager所設計，而非針對Adobe Managed Services (AMS)上的Cloud Manager所設計。 不過，有許多概念都是相同的。 |
