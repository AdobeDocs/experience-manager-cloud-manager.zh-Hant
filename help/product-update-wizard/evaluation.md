...
* 受升級影響或覆寫的區域中的規則違規。
* 它會偵測不向後相容且升級後可能失敗的AEM 6.x功能或API。
...
此模式偵測器可在任何環境中執行。 不過，為了提高偵測率並避免對關鍵執行個體造成任何效能影響，Cloud Manager會在製作執行個體的中繼環境中執行。
...
1. 精靈會通知您操作狀態。 附註&#x200B;**進行中**&#x200B;或&#x200B;**已完成** （如適用），同時正在產生評估報告。

1. 報告產生後，您可以按一下「**[!UICONTROL 下載報告]**」儲存副本。

   ![報告已建立](/help/assets/Evaluation-1.png)

Cloud Manager中目前的產品更新精靈僅支援&#x200B;**評估**&#x200B;階段。 即將推出其他四個階段，即&#x200B;**修正**、**執行**、**驗證**&#x200B;及&#x200B;**完成**。
